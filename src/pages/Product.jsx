...
aspect-square w-8 flex justify-center items-center text-yellow-700 m-auto mt-56">$</div>
  ...
  return (
    ...
    <main>
      ...
      <div className='flex items-center justify-around mt-14y' >
        <p className="font-semibold ... text-xl text-orange-400">Showing 23 out of 23 products</p>
